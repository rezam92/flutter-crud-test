...
class _CreateCustomerState extends State<CreateCustomer> {
  ...
  final backAccountNumberController = TextEditingController();
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<CreateCustomerCubit, CreateCustomerState>(listener: (context, state) {
      ...
      if (state is CreateCustomerInitial || state is CreateCustomerCreating || state is CreateCustomerError) {
        return Scaffold(
          floatingActionButton: FloatingActionButton.extended(
            onPressed: () async {
              // if(state is CreateCustomerCreating) return;
              ...
              if (_key.currentState!.validate()) {
                var res = await context.read<CreateCustomerCubit>().createCustomer(
                      customer: Customer(
            ...
            label: state is CreateCustomerCreating ? const CupertinoActivityIndicator() : const Text('Submit'),
          ),
          body: SafeArea(
            child: Form(
              key: _key,
